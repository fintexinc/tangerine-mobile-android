...
internal fun DetailsUi(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        val accountItems = listOf(
            ...
            Triple(stringResource(R.string.text_account_registration), "Mr. Jack Dawson", false),
            Triple(stringResource(R.string.text_account_type), "TFSA", false),
        ...
        accountItems.forEachIndexed { index, (label, value, hasInfo) ->
